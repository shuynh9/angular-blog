...
export class PostService {
  ...
  getAllPosts() : Observable<BlogPost[]>{
    return this.http.get<BlogPost[]>(`https://bti425-assignment04.herokuapp.com/api/posts?page=1&perPage=${Number.MAX_SAFE_INTEGER}`)
  }

  newPost(data:BlogPost) : Observable<any>{
    return this.http.post<any>('https://bti425-assignment04.herokuapp.com/api/posts', data);
  }

  updatePostById(id:string, data:BlogPost) : Observable<any>{
    return this.http.put<any>(`https://bti425-assignment04.herokuapp.com/api/posts/${id}`, data);
  }

  deletePostById(id: string) : Observable<any>{
    return this.http.delete<any>(`https://bti425-assignment04.herokuapp.com/api/posts/${id}`);
  }
